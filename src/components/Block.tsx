...
//   const toggleText = isOpen ? `Hide ${title.replace('💡 ', '').replace('🚀 ', '').replace('🌟 ', '')}` : `Show ${title.replace('💡 ', '').replace('🚀 ', '').replace('🌟 ', '')}`;
...
//               <h4 className="font-semibold text-lg text-green-700 mb-2" style={{ fontFamily: 'Comic Sans MS, cursive' }}>
//                 How to do it:
//               </h4>
...
//           {details.example && (
//             <>
//               <h4 className="font-semibold text-lg text-green-700 mb-1" style={{ fontFamily: 'Comic Sans MS, cursive' }}>Example:</h4>
//               <p>{details.example}</p>
//             </>
//           )}
//           {details.explanation && (
//             <>
//               <h4 className="font-semibold text-lg text-green-700 mb-1" style={{ fontFamily: 'Comic Sans MS, cursive' }}>Explanation:</h4>
...
//           {details.fact && (
//             <>
//               <h4 className="font-semibold text-lg text-purple-600 mb-1" style={{ fontFamily: 'Comic Sans MS, cursive' }}>Fun Fact:</h4>
//               <p>{details.fact}</p>
//             </>
//           )}
//         </div>
